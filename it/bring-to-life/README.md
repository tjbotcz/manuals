...
`` `
"C: \ Programmi \ PuTTY \ pscp.exe" file.txt pi @ tuo_pi: Desktop / tjbotcz_lite
`` `
...
`` `
scp file.txt pi @ tuo_pi: ~ / Desktop / tjbotcz_lite
`` `
...
`` `
scp pi@192.168.1.10: /home/pi/Desktop/tjbotcz_lite/config.js Utenti / Honza / Desktop
`` `
